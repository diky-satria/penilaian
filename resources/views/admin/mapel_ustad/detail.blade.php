...
<div class="container-fluid px-4">
    <div class="content-top">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="/tahun_pelajaran/{{ $thn_pelajaran->id }}/mapel_ustad">mapel ustad</a></li>
            <li class="breadcrumb-item active"><a href="/tahun_pelajaran/{{ $thn_pelajaran->id }}/mapel_ustad/{{ $mapel_ustad->id }}/detail">Detail</a></li>
        </ol>
    </div>
    <div class="row" style="padding:0 10px;">
        <div class="col-12 col-md-12 bg-table">
            <div class="row mb-3">
                <div class="col">
                    <div class="float-end">
                        <a href="/tahun_pelajaran/{{ $thn_pelajaran->id }}/mapel_ustad" class="btn btn-sm btn-dark me-1">Kembali</a>
                    </div>
                </div>
            </div>
            <div class="row">
...
<script>
    ...
    $('#tab-nilai').DataTable({
        ...
        responsive: true,
        ajax: {
            url: '/tahun_pelajaran/'+thn_pelajaran_id+'/mapel_ustad/'+mapel_ustad_id+'/detail',
        },
        columns: [
            {
    ...
    $(document).on('click', '.edit-nilai', function(){
        ...
        $.ajax({
            type: "GET",
            url: "/tahun_pelajaran/"+id_thn_pelajaran+"/mapel_ustad/"+id_mapel_ustad+"/detail/"+id_nilai+"/edit",
    ...
    $(document).on('submit', '#form-edit-nilai', function(e){
        ...
        $.ajax({
            type: "POST",
            url: "/tahun_pelajaran/"+id_thn_pelajaran+"/mapel_ustad/"+id_mapel_ustad+"/detail/"+id_nilai+"/update",
            data: formData,
            contentType: false,
            processData: false, 
            success: function(response){
