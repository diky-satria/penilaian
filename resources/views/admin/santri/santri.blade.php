...
<div class="container-fluid px-4">
    <div class="content-top">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item active"><a href="{{ url('santri') }}">santri</a></li>
        </ol>
    </div>
    <div class="row" style="padding:0 10px;">
        <div class="col-12 col-md-12 bg-table">
            <div class="row mb-3">
                <div class="col">
                    <a href="{{ url('santri/tambah') }}" class="btn btn-sm btn-primary float-end">Tambah</a>
                </div>
            </div>
            <div class="row">
    ...
    $(document).ready(function(){
        ...
        $('#tab-siswa').DataTable({
            ...
            columns: [
                ...
                {data: 'wali', name: 'wali'},
                {data: 'telepon_wali', name: 'telepon_wali'},
        ...
        $(document).on('click', '.hapus-siswa', function(){
            ...
            Swal.fire({
                ...
                text: "ingin menghapus santri ini",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        error: function(){
                            toastFail.fire({
                                icon: 'error',
                                title: 'Santri gagal dihapus, ada data yang berelasi dengan santri ini'
                            })
                        }
                    })
