...
<div class="container-fluid px-4">
    <div class="content-top">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item active"><a href="{{ url('ustad') }}">guru</a></li>
        </ol>
    </div>
    <div class="row" style="padding:0 10px;">
        <div class="col-12 col-md-12 bg-table">
            <div class="row mb-3">
                <div class="col">
                    <a href="{{ url('ustad/tambah') }}" class="btn btn-sm btn-primary float-end">Tambah</a>
                </div>
            </div>
            <div class="row">
    ...
    $(document).ready(function(){
        ...
        $('#tab-guru').DataTable({
            ...
            columns: [
                ...
                {data: 'nip', name: 'nip'},
                {data: 'nama_ustad', name: 'nama_ustad'},
