...
<div class="container-fluid px-4">
    <div class="content-top">
        <h1 style="font-size:20px;">Edit Ustad</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ url('ustad') }}">ustad</a></li>
            <li class="breadcrumb-item active"><a href="{{ url('ustad/edit/'.$data['id']) }}">edit ustad</a></li>
        </ol>
    </div>
    <div class="row" style="padding:0 10px;">
        <div class="col-12 col-md-5 bg-table">
            ...
            <form action="" id="form-edit-guru">
                ...
                <div class="form-group mb-3">
                    <label>Nama</label>
                    <input type="text" name="nama-edit" id="nama-edit" class="form-control fc-edited" value="{{ $data['nama_ustad'] }}">
                </div>
                <div class="form-group mb-3">
                    <label>Email</label>
