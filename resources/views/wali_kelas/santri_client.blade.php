...
<div class="container-fluid px-4">
    <div class="content-top">
        <h1 style="font-size:20px;">Santri</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ url('kelasku') }}">kelasku</a></li>
            <li class="breadcrumb-item active"><a href="{{ url('kelasku/'. $route_id .'/santri_client') }}">santri</a></li>
        </ol>
    </div> 
...
$(document).ready(function(){
    ...
    function ambilData(){
        ...
        $.ajax({
            type: "GET",
            url: "/kelasku/"+ route_id +"/ambil_data",
