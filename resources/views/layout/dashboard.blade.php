...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand" style="background-color:white;">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="{{ url('/dashboard') }}" style="color:#5034FF;"><b>MAGHFIROH-N</b></a>
            <!-- Sidebar Toggle-->
            <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" href="#!"><i class="fas fa-bars" style="color:#ABABAB;"></i></button>
                ...
                <nav class="sb-sidenav accordion side-bg-edited" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link nav-link-edited collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested">
                                    <a id="ustad_active" class="nav-link nav-link-edited {{ Request::is('ustad') ? 'active' : '' }}" href="{{ url('ustad') }}">
                                        <div class="link-side d-flex">
                                            <div class="sb-nav-link-icon"><i class="fa-solid fa-people-group"></i></div>
                                            Guru
                                        </div>
                                    </a>
                                    <a id="santri_active" class="nav-link nav-link-edited {{ Request::is('santri') ? 'active' : '' }}" href="{{ url('santri') }}">
                                        <div class="link-side d-flex">
                                            <div class="sb-nav-link-icon"><i class="fa-solid fa-user-graduate"></i></i></div>
                                            Santri
                                        </div>
                                    </a>
                                    <a id="mapel_active" class="nav-link nav-link-edited {{ Request::is('mata_pelajaran') ? 'active' : '' }}" href="{{ url('mata_pelajaran') }}">
                                        <div class="link-side d-flex">
                            ...
                            <a class="nav-link nav-link-edited {{ Request::is('tahun_pelajaran') ? 'active' : '' }}" href="{{ url('tahun_pelajaran') }}">
                                <div class="link-side d-flex">
                            ...
                            @if(Auth::user()->role == 'ustad' || Auth::user()->role == 'wali_kelas')
        ...
        <script>
            ...
            // link active ustad
            let ustad_active = $('#ustad_active')
            if(ustad_active.hasClass('active')){
                $('#collapseLayouts').addClass('show')
            }
            // link active santri
            let santri_active = $('#santri_active')
            if(santri_active.hasClass('active')){
                $('#collapseLayouts').addClass('show')
            }
            // link active mapel
