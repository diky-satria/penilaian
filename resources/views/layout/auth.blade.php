...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light" style="background-color:white;">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/dashboard') }}" style="color:#5034FF;"><b>MAGHFIROH-N</b></a>
            ...
            <div class="navbar-nav ms-auto" style="font-size:14px;">
                <a class="nav-link px-3 btn btn-primary" style="border-radius:20px;color:white;font-weight:bold;" href="{{ url('/') }}">Login</a>
            </div>
            </div>
        </div>
    </nav>
    ...
    <div class="container" style="margin-top:56px;">
        <div class="row" style="height:90vh;">
            <div class="col-md-8 gambar">
                <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel" style="height:100%;display:flex;align-items:center;">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active" data-bs-interval="4000">
                            <center><img src="{{ asset('carousel-img/img1.png') }}"></center>
                        </div>
                        <div class="carousel-item" data-bs-interval="2000">
                            <center><img src="{{ asset('carousel-img/img2.png') }}"></center>
                        </div>
                        <div class="carousel-item">
                            <center><img src="{{ asset('carousel-img/img3.png') }}"></center>
                        </div>
                    </div>
                </div>
            </div>
