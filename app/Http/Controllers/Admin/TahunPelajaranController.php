...
class TahunPelajaranController extends Controller
{
        ...
        if(request()->ajax()){  
            return datatables()->of($t_pel)
                                ...
                                ->addColumn('action', function($t_pel){
                                   ...
                                   $button .= "<a href='/tahun_pelajaran/".$t_pel->id."/mapel_ustad' class='btn btn-sm btn-info ms-1' id='".$t_pel->id."'>Mapel Guru</a>";
                                    return $button;
                                })
    ...
    public function update($id)
    {
        ...
        if(request('tahun_pelajaran_edit') !== request('tahun_pelajaran_old') && count($thn_pelajaran) > 0  
